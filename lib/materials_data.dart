  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'War Ensemble 44CE Metal can only drop from the War Ensemble Forcemen, Red Napalm, after defeating her on Nightmare difficulty on 17F KYUZAKA. Forcemen may be fought for free on each difficulty once per day.'),
          Text(''),
          Text('Can also be received as a reward from monthly Season Quests.'),
          Text(''),
          Text('Available Floors'),
          Text('17F - KYUZAKA - WED / SUN'),
          Text('BOSS: Red Napalm - Nightmare.'),
          Text('Entry Fee: 100000 KC'),
        ],
      ),
    ),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'Candle Wolf Blue Metals do not drop from a mid-boss, so they only naturally drop from Trap Rooms and Haters.'),
          Text(''),
          Text(
              'Drops in Max\'s Area (1-10F) and Jackson\'s Area (11-20F) from Gold Chests; found in Trap Rooms or from Haters. Above 41F, the Hardcore Haters may rarely drop this from Gold Chests at a low rate. White Steel and Black Thunder have a chance to drop this metal on Hard difficulty.'),
          Text(''),
          Text(
              'Can be bought for 20000 KC from Gyaku-Funsha, 50000 RE-Points from the R-Point Exchange, or with 4 Death Metals (for x1) / 16 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'Candle Wolf Green Metals drop from the Candle Wolf Mid-Boss, GOTO-9, on 11F MAKA-TSUTSUMI. He may drop damaged Candle Wolf equipment or Kill Coins instead.'),
          Text(''),
          Text(
              'Drops in Jackson\'s Area (11-20F) and Crowley\'s Area (21-30F) from Gold Chests; found in Trap Rooms or from Haters. Above 41F, the Hardcore Haters may rarely drop this from Gold Chests at a low rate. White Steel and Black Thunder have a chance to drop this metal on Hard difficulty.'),
          Text(''),
          Text(
              'Can be bought for 30000 KC from Gyaku-Funsha, 75000 RE-Points from the R-Point Exchange, or with 6 Death Metals (for x1) / 24 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
          Text(
              'Can be received as a reward from Quests, Bronze / Silver / Gold Lost Bags, or Bronze / Silver Box Uncle Prime.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'Candle Wolf Black Metals drop from the Candle Wolf Mid-Boss, GOTO-9, on 23F ECHIZEN-JIMA, and from their Don, Mr. Crowley, on 30F SAIGETSU. They may drop damaged Candle Wolf equipment or Kill Coins instead.'),
          Text(''),
          Text(
          ...
          Text(''),
          Text(
              'Can be bought for KC 40000 KC from Gyaku-Funsha, RE-Points 100000 RE-Points from the R-Point Exchange, or with DM 8 (for x1) / 32 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
          Text(
              'Can be received as a reward from Quests, Silver / Gold Lost Bags, or Silver / Gold Box Uncle Prime.'),
          Text(''),
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          ...
          Text(''),
          Text(
              'Can be bought for KC 50000 KC from Gyaku-Funsha, 125000 RE-Points from the R-Point Exchange, or with 10 Death Metals (for x1) / 40 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
          Text(
              'Can be received as a reward from Quests, Gold / Platinum Lost Bags, or Gold Box Uncle Prime.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'Candle Wolf Purple Metals start to drop in the Battle To The Top area (41F+), from Gold Chests in the Treasure Rooms on dead-end floors, or from Hardcore Haters. Typically, this means you have a chance at 1 Purple metal per run.'),
          Text(''),
          Text(
              'In Tengoku, Purple Metals appear as Legendary Chest rewards, though will stop appearing in them after 100F. They can still appear as Gold Chest rewards at any point. They can drop directly from either Treasure Tubers or the corresponding faction Mid-Boss. Gold Chests from Hardcore Haters can drop them at any floor, but at a much, much lower rate. Due to the nature of Tengoku rewards, many more Purple metals can be obtained at once compared to runs in the 40\'s.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'latinum Metals only appear in Tengoku, starting at 80F. They can appear as rare Legendary Chest rewards, and can also appear as Gold Chest rewards. At 80F or above, they can drop directly from either Treasure Tubers or the corresponding faction Mid-Boss. Gold Chests from Hardcore Haters can drop them above 80F, but at a much, much lower rate.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'Candle Wolf 44CE Metal can only drop from the Candle Wolf Forcemen, Black Thunder, after defeating him on Nightmare difficulty on 30F NANBOKUCHO. Forcemen may be fought for free on each difficulty once per day.'),
          Text(''),
          Text('Can also be received as a reward from monthly Season Quests.'),
          Text(''),
          Text('Available Floors'),
          Text('30F - NANBOKUCHO - WED / SUN'),
          Text('BOSS: Black Thunder - Nightmare.'),
          Text('Entry Fee: 100000 KC'),
        ],
      ),
    ),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'M.I.L.K. Blue Metals do not drop from a mid-boss, so they only naturally drop from Trap Rooms and Haters.'),
          Text(''),
          Text(
              'Drops in Max\'s Area (1-10F) and Jackson\'s Area (11-20F) from Gold Chests; found in Trap Rooms or from Haters. Above 41F, the Hardcore Haters may rarely drop this from Gold Chests at a low rate. White Steel and Pale Wind have a chance to drop this metal on Hard difficulty.'),
          Text(''),
          Text(
              'Can be bought for 20000 KC from Gyaku-Funsha, 50000 RE-Points from the R-Point Exchange, or with 4 Death Metals (for x1) / 16 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'M.I.L.K. Green Metals do not drop from a mid-boss, so they only naturally drop from Trap Rooms and Haters.'),
          Text(''),
          Text(
              'Drops in Jackson\'s Area (11-20F) and Crowley\'s Area (21-30F) from Gold Chests; found in Trap Rooms or from Haters. Above 41F, the Hardcore Haters may rarely drop this from Gold Chests at a low rate. White Steel and Pale Wind have a chance to drop this metal on Hard difficulty.'),
          Text(''),
          Text(
              'Can be bought for 30000 KC from Gyaku-Funsha, 75000 RE-Points from the R-Point Exchange, or with 6 Death Metals (for x1) / 24 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'M.I.L.K. Black Metals do not drop from a mid-boss, so they only naturally drop from Trap Rooms and Haters.'),
          Text(''),
          Text(
          ...
          Text(''),
          Text(
              'Can be bought for 40000 KC from Gyaku-Funsha, 100000 RE-Points from the R-Point Exchange, or with DM 8 (for x1) / 32 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
          Text(
              'Can be received as a reward from Quests, Silver / Gold Lost Bags, or Silver / Gold Box Uncle Prime.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'M.I.L.K. Red Metals drop from the M.I.L.K. Mid-Boss, U-10, on 32F KATSUMA, and from their Don, Taro Gunkanyama, on 40F FUTAGI. They may drop damaged M.I.L.K. equipment or Kill Coins instead.'),
          Text(''),
          Text(
              'Drops in Gunkanyama\'s Area (31-40F) from Gold Chests; found in Trap Rooms or from Haters. In the Battle To The Top area (41F+), this metal may be found in Gold Chests from the Treasure Rooms on dead-end floors. Hardcore Haters above 41F and in Tengoku may drop this from Gold Chests at a low rate. White Steel and Pale Wind have a chance to drop this metal on Hard difficulty.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'M.I.L.K. Purple Metals start to drop in the Battle To The Top area (41F+), from Gold Chests in the Treasure Rooms on dead-end floors, or from Hardcore Haters. Typically, this means you have a chance at 1 Purple metal per run.'),
          Text(''),
          Text(
              'In Tengoku, Purple Metals appear as Legendary Chest rewards, though will stop appearing in them after 100F. They can still appear as Gold Chest rewards at any point. They can drop directly from either Treasure Tubers or the corresponding faction Mid-Boss. Gold Chests from Hardcore Haters can drop them at any floor, but at a much, much lower rate. Due to the nature of Tengoku rewards, many more Purple metals can be obtained at once compared to runs in the 40\'s.'),
          Text(''),
          Text(
              'Can be bought for RE-Points 150000 RE-Points from the R-Point Exchange, 6000 Bloodnium in the Bloodnium Exchange, or with 12 Death Metals (for x1) / 48 (for x5) Death Metals if appearing in the daily Hernia lineup.'),
          Text(''),
          Text(
              'Can be received as a reward from annual Event Quests or Gold / Platinum Lost Bags.'),
          Text(''),
  ...
  RnDMaterial(
    ...
    where: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: const [
          Text(
              'M.I.L.K. 44CE Metal can only drop from the M.I.L.K. Forcemen, Pale Wind, after defeating him on Nightmare difficulty on 38F TAKANOWA. Forcemen may be fought for free on each difficulty once per day.'),
          Text(''),
          Text('Can also be received as a reward from monthly Season Quests.'),
          Text(''),
          Text('Available Floors'),
          Text('38F - TAKANOWA - WED / SUN'),
          Text('BOSS: Pale Wind - Nightmare.'),
          Text('Entry Fee: 100000 KC'),
        ],
      ),
    ),
